...
public class CharacterInputController : MonoBehaviour
{
    ...
    public void Init()
    {
        ...
        {
            maxLife += character.accessories[PlayerData.instance.usedAccessory].extralife;

            trackManager.accmulti = character.accessories[PlayerData.instance.usedAccessory].multiplier;
            //trackManager.accmulti += PlayerData.instance.rewardmultiplier;
        }
        currentLife = maxLife;
