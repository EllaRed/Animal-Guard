...
{
    public string gameidandroid = "3864663";
    ...
    public Text accesoryDescDisplay;
    public Text mapmultiplier;
	[Header("Other Data")]
    ...
    public bool newchar;
    public GameObject newstuffalert;
    ...
    protected const string k_ShopSceneName = "testshop";
    ...
    protected int themenum=0;
    public override void Enter(AState from)
    {
      
        inventoryCanvas.gameObject.SetActive(true);
        missionPopup.gameObject.SetActive(false);
        Themezone.SetActive(false);
        charNameDisplay.text = "";
        themeNameDisplay.text = "";
        mapmultiplier.text = "X"+PlayerData.instance.rewardmultiplier.ToString();
        k_UILayer = LayerMask.NameToLayer("UI");
        if(PlayerData.instance.highscores.Count>=1)
        highscore.text = PlayerData.instance.highscores[0].score.ToString(); 
    ...
    public override void Tick()
    {
        ...
        newstuffalert.SetActive(newchar);
    }
    ...
    {
       Themezone.SetActive(!challenges[challengeid].activeSelf);
        challenges[challengeid].SetActive(!challenges[challengeid].activeSelf);
    }
    public IEnumerator PopulateTheme()
    {
        themes[themenum].SetActive(false);
        ThemeData t = null;
        ...
        themes[t.mainmenupropid].SetActive(true);
        themenum = t.mainmenupropid;
  ...
  //themeIcon.sprite = t.themeIcon;
        ...
        if (!m_IsLoadingCharacter)
        {
            ...
            while (newChar == null)
            {
                ...
                if (c != null)
                {
                    ...
                    if (m_OwnedAccesories.Count > 0)
                    {
                        m_UsedAccessory = PlayerData.instance.usedAccessory;
                    }
                    else PlayerData.instance.usedAccessory = -1;
    ...
    void SetupAccessory()
    {
        ...
        else
        {
            ...
            accesoryDescDisplay.text = c.accessories[PlayerData.instance.usedAccessory].minidesc;
            if(PlayerData.instance.rewardmultiplier>1)
            mapmultiplier.text = "X" + (PlayerData.instance.rewardmultiplier + c.accessories[PlayerData.instance.usedAccessory].multiplier ).ToString();
            else mapmultiplier.text = "X" + (PlayerData.instance.rewardmultiplier + c.accessories[PlayerData.instance.usedAccessory].multiplier -1).ToString();
        }
    }
	...
	public void SetModifier(Modifier modifier, Levelsettings level)
	{
		m_CurrentModifier = modifier;
        manager.currentlevel = level.levelid;
        manager.minscore=level.minscore;
	}
