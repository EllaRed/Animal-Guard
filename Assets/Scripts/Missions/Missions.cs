...
public class EnemyMission : MissionBase
{
    int previoushits;
    public override bool HaveProgressBar()
    {
    ...
    public override void Update(TrackManager manager)
    {
        int hits = manager.hitcount - previoushits;
        progress += hits;

        previoushits = manager.hitcount;
    }
}